...
rule version_snakemake:
    output:
        f"{RESULT_DIR}/04_stats/02_separate_tables/software/snakemake.txt",
    shell:
        """
...
rule version_adapterremoval:
    output:
        f"{RESULT_DIR}/04_stats/02_separate_tables/software/adapterremoval.txt",
    conda:
...
rule version_bwa:
    output:
        f"{RESULT_DIR}/04_stats/02_separate_tables/software/bwa.txt",
    conda:
        "../envs/bwa.yaml"
    envmodules:
        module_bwa,
...
rule version_bowtie2:
    output:
        f"{RESULT_DIR}/04_stats/02_separate_tables/software/bowtie2.txt",
    conda:
        "../envs/bowtie2.yaml"
    envmodules:
        module_bowtie2,
...
rule version_fastqc:
    output:
        f"{RESULT_DIR}/04_stats/02_separate_tables/software/fastqc.txt",
    conda:
        "../envs/fastqc.yaml"
    envmodules:
        module_fastqc,
...
rule version_gatk3:
    output:
        f"{RESULT_DIR}/04_stats/02_separate_tables/software/gatk.txt",
    conda:
        "../envs/gatk3.yaml"
    envmodules:
        module_gatk3,
...
rule version_mapdamage2:
    output:
        f"{RESULT_DIR}/04_stats/02_separate_tables/software/mapdamage2.txt",
    conda:
        "../envs/mapdamage.yaml"
    envmodules:
        module_mapdamage,
...
rule version_picard:
    output:
        f"{RESULT_DIR}/04_stats/02_separate_tables/software/picard.txt",
    conda:
        "../envs/picard.yaml"
    envmodules:
        module_picard,
...
rule version_samtools:
    output:
        f"{RESULT_DIR}/04_stats/02_separate_tables/software/samtools.txt",
    conda:
        "../envs/samtools.yaml"
    envmodules:
        module_samtools,
...
rule version_bcftools:
    output:
        f"{RESULT_DIR}/04_stats/02_separate_tables/software/bcftools.txt",
    conda:
        "../envs/bcftools.yaml"
    envmodules:
        module_bcftools,
...
rule version_bamutil:
    output:
        f"{RESULT_DIR}/04_stats/02_separate_tables/software/bamutil.txt",
    conda:
        "../envs/bamutil.yaml"
    envmodules:
        module_bamutil,
...
rule version_bedtools:
    output:
        f"{RESULT_DIR}/04_stats/02_separate_tables/software/bedtools.txt",
    conda:
        "../envs/bedtools.yaml"
    envmodules:
        module_bedtools,
...
rule version_seqtk:
    output:
        f"{RESULT_DIR}/04_stats/02_separate_tables/software/seqtk.txt",
    conda:
        "../envs/seqtk.yaml"
    envmodules:
        module_seqtk,
...
rule version_dedup:
    output:
        f"{RESULT_DIR}/04_stats/02_separate_tables/software/dedup.txt",
    conda:
        "../envs/dedup.yaml"
    envmodules:
        module_dedup,
...
rule version_qualimap:
    output:
        f"{RESULT_DIR}/04_stats/02_separate_tables/software/qualimap.txt",
    conda:
        "../envs/qualimap.yaml"
    envmodules:
        module_qualimap,
...
rule version_multiqc:
    output:
        f"{RESULT_DIR}/04_stats/02_separate_tables/software/multiqc.txt",
    conda:
        "../envs/multiqc.yaml"
    envmodules:
        module_multiqc,
...
rule version_glimpse:
    output:
        f"{RESULT_DIR}/04_stats/02_separate_tables/software/glimpse.txt",
    conda:
        "../envs/glimpse.yaml"
    envmodules:
        module_glimpse,
...
rule version_fastp:
    output:
        f"{RESULT_DIR}/04_stats/02_separate_tables/software/fastp.txt",
    conda:
        "../envs/fastp.yaml"
    envmodules:
        module_fastp,
...
rule version_r:
    output:
        f"{RESULT_DIR}/04_stats/02_separate_tables/software/R.txt",
    conda:
        "../envs/r.yaml"
    envmodules:
        module_r,
