...
rule remove_duplicates:
    ...
    params:
        rmdup_params=recursive_get(config, [ ["markduplicates", {}], ["params", "REMOVE_DUPLICATES=true"] ]),
        PICARD=recursive_get(config, [ ["software",{}], ["picard_jar", "picard.jar"] ]),
...
rule mapDamage_stats:
    ...
    params:
        params=recursive_get(config, [ ["mapdamage", {}], ["params", ""] ]),
    conda:
        "../envs/mapdamage.yaml"
    message:
        "--- MAPDAMAGE {input.bam}"
