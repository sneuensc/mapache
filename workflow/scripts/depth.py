...
parser.add_argument(
    ...
    type=float,
    dest="malelimit",
    help="Upper R_y limit for assignment as XY/male",
    default=0.075,
)
parser.add_argument(
    "--femalelimit",
    ...
    type=float,
    dest="femalelimit",
    help="Lower R_y limit for assignment as XX/female",
    default=0.016,
)
parser.add_argument(
    "--digits",
    ...
    type=int,
    dest="digits",
    help="Number of decimal digits in R_y output",
    default=4,
)
parser.add_argument(
    "--noheader",
    action="store_true",
    dest="noheader",
    help="Do not print header describing the columns in the output",
    default=False,
)
parser.add_argument(
    "--female",
...
if total_count > 0:
    ...
    print(
        "Total: %.3f\t%i\t%i\t%.1f"
        % (totalReadlength / totalLength, totalReadlength, totalLength, totalAvgReadL)
    )
else:
...
if chrX_counts > 0:
    ...
    if args.noheader == False:
        ...
        print(
            ...
            chrY_counts,
            "\t",
            round(Ry, args.digits),
            "\t",
            round(SE, args.digits),
            "\t",
            str(round(Ry - confinterval, args.digits))
            + "-"
            + str(round(Ry + confinterval, args.digits)),
            "\t",
            gender,
