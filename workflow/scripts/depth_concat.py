...
## concatenate depths
if snakemake.input[0][:17] == "results/03_sample":
    df = pd.DataFrame(columns=['Sample','AvgReadDepth_tot', 
...
df.to_csv(snakemake.output[0], index = None, header=True)
