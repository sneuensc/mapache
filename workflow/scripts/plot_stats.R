...
plot_1_nb_reads      = get_args(argsL, "out_1_reads", "plot_1_nb_reads.png")
plot_2_mapped        = get_args(argsL, "out_2_mapped", "plot_2_mapped.png")
plot_3_endogenous    = get_args(argsL, "out_3_endogenous", "plot_3_endogenous.png")
plot_4_duplication   = get_args(argsL, "out_4_duplication", "plot_4_duplication.png")
