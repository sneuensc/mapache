<<<<<<< HEAD:workflow/scripts/bamdamage.pl
#!/usr/bin/perl
=======
#!/usr/bin/env perl
## #!/software/bin/perl -w
>>>>>>> 88095e9cbf16ac50e690705e1c805f19913059c2:workflow/scripts/bamdamage
...
$Global::version = "20140602_extended_bySam_20211025";
...
print 
print R R_script($opt::sample||$file_no_bam, $outfile, $outfile_length, @out);
close R;
...
sub usage {
  ...
  "  --nth_read=s                             subsample: consider only nth alignment (1; each line)\n",
  ...
  my @script =
    (
      ...
      q(
        ...
        bp=barplot(mat2,main="read length distribution",xlab="read length",ylab="frequency",col="dodgerblue4",names.arg=data1[1,],lwd=1,cex.axis=0.6,cex.lab=0.6,cex.main=0.8,axes=FALSE,axisnames=FALSE)
        print(data1[1,]);
        
        axis(2, cex.axis = 0.6,tck=-0.005)
        axis(1, at=bp,labels=data1[1,], cex.axis = 0.6,tick=FALSE)
        #labels=data1[1,]
        ...
        plot(nda[,3], main=paste("damage pattern 5' end",sample_name,sep=" "),xlab="position from 5' end",ylab="frequency",ylim=c(0,yma),col="black",type="l",lwd=0.0,cex.axis=0.6,cex.lab=0.6,cex.main=0.8);
        ...
        plot(nda[,3], main=paste("damage pattern 3' end",sample_name,sep=" "),xlab="position from 3' end",ylab="frequency",ylim=c(0,yma),col=2,type="l",lwd=1,cex.axis=0.6,cex.lab=0.6,cex.main=0.8,xlim=rev(range(0:(length(nda[,3])-1))));
        #points(nda[,4],type="l",col="deepskyblue1",lwd=2);
        #points(nda[,15],type="l",,col="darkorange",lwd=2);
        count = 0;
        for (i in 2:17) {
